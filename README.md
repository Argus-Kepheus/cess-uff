...
**Language / Idioma:** [English](README.md) | [Português](docs/PT/README.md)
...
[`docs/EN/hardware-reference.md`](docs/EN/hardware-reference.md); exact
per-part identifiers are in
[`docs/EN/component-specifications.md`](docs/EN/component-specifications.md).
...
- The push-button uses the ESP32's internal pull-down resistor (`Pin.PULL_DOWN`); no external resistor is required.
- The OLED uses I2C (`machine.I2C`) at address `0x3C`, driven by
  `ssd1306.py`.

Full requirements and design rationale are in
[`docs/EN/technical-specification.md`](docs/EN/technical-specification.md).
