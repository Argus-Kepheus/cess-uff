...
\begin{table}[htbp]
  ...
  $^{1}$Identificação do conector (J2 ou J3) e da posição do terminal no cabeçalho físico de 38 pinos da ESP32-DevKitC V4, conforme \texttt{docs/hardware-reference.md}.
\end{table}
