"""
Temporary SSD1306 OLED diagnostic test.

Purpose:
    Test the main capabilities of the 128x64 SSD1306 OLED connected
    through I2C, including full-screen pixel activation, pixel addressing,
    drawing primitives, text, inversion, contrast, display power control,
    and framebuffer scrolling.

This file is intended only for hardware and simulation diagnostics.
Restore the official project main.py after completing the test.
